...
const checkout_1 = __importDefault(require("../../services/basket/controller/checkout"));
describe("/checkout", () => {
    it("unAuthorized request", () => __awaiter(void 0, void 0, void 0, function* () {
        let response = yield (0, checkout_1.default)({}, []);
    ...
    it("Correct request", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        let response = yield (0, checkout_1.default)({ id: 1 }, []);
        expect(response).toEqual({
            status: 200,
