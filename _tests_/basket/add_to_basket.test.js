...
const add_to_basket_1 = __importDefault(require("../../services/basket/controller/add_to_basket"));
describe("/add_to_basket", () => {
    it("unAuthorized request", () => __awaiter(void 0, void 0, void 0, function* () {
        let response = yield (0, add_to_basket_1.default)({}, "1");
