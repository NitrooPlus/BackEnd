...
const delete_from_basket_1 = __importDefault(require("../../services/basket/controller/delete_from_basket"));
describe("/delete_from_basket", () => {
    it("unAuthorized request", () => __awaiter(void 0, void 0, void 0, function* () {
        let response = yield (0, delete_from_basket_1.default)({}, "1");
    ...
    it("Correct request", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        let response = yield (0, delete_from_basket_1.default)({ id: 1 }, "1");
        expect(response).toEqual({
            status: 200,
