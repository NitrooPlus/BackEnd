...
const get_product_1 = __importDefault(require("../../services/search/controller/get_product"));
describe("/search_product", () => {
    it("Correct request", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const response = yield (0, get_product_1.default)("correct value", 0, 0);
    ...
    it("Internal error", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const response = yield (0, get_product_1.default)("wrong value", 1, 1);
