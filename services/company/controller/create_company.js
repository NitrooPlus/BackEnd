...
function create_company(company, user) {
    var _a, _b, _c;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const obj = (0, class_transformer_1.plainToInstance)(company_1.Company, company);
    ...
    VALUES ('${obj.title}','${obj.url}','${obj.location}',${obj.logo ? `'${obj.logo}'` : null},${obj.header_image ? `'${obj.header_image}'` : null},${obj.description ? `'${obj.description}'` : null},${user.id})`);
            ...
            if (((_b = e === null || e === void 0 ? void 0 : e.message) === null || _b === void 0 ? void 0 : _b.indexOf("company.title_index")) >= 0)
                return { status: 400, content: { title: 'عنوان تکراری است' } };
            if (((_c = e === null || e === void 0 ? void 0 : e.message) === null || _c === void 0 ? void 0 : _c.indexOf("company.url_index")) >= 0)
                return { status: 400, content: { url: 'عنوان تکراری است' } };
            return { status: 500, content: { message: "مشکلی پیش آمده است" } };
        }
    });
}
exports.default = create_company;
