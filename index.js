...
app.use((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d;
    try {
        const result = yield (0, check_auth_1.check_auth)((_a = req.cookies) === null || _a === void 0 ? void 0 : _a[process.env.COOKIE_NAME || 'cookie'], (dec) => __awaiter(void 0, void 0, void 0, function* () {
            return true;
        }));
